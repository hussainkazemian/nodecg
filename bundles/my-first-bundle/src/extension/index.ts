...
module.exports = function (nodecg: NodeCG.ServerAPI) {
	...
	// Speaker replicants for tutorial
	nodecg.Replicant("speakerReplicant", { defaultValue: "Maija Mehiläinen" });
	nodecg.Replicant("speakerTitleReplicant", { defaultValue: "Ohjelmistokehittäjä" });
	nodecg.Replicant("lowerThirdVisible", { defaultValue: false });
